...
import com.qq281982108.pinnedheaderexpandablelistview.model.Account;
import com.qq281982108.pinnedheaderexpandablelistview.model.RecorderTime;
...
public class MainActivity extends Activity implements
    ...
    private ArrayList<List<RecorderTime>> childList;
    ...
    void initData() {
        ...
        childList = new ArrayList<List<RecorderTime>>();
        for (int i = 0; i < groupList.size(); i++) {
            ArrayList<RecorderTime> childTemp;
            if (i == 0) {
                childTemp = new ArrayList<RecorderTime>();
                for (int j = 0; j < 13; j++) {
                    RecorderTime people = new RecorderTime();
                    people.setName("yy-" + j);
                    people.setAge(30);
    ...
    public void updatePinnedHeader(View headerView, int firstVisibleGroupPos) {
        if (adapter.getGroupCount() > 0) { // 防止列表在无数据的情况崩溃
            Account firstVisibleGroup = (Account) adapter.getGroup(firstVisibleGroupPos);
    ...
    class MyexpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            groupHolder.textView.setText(((Account) getGroup(groupPosition))
                    .getTitle());
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            childHolder.textName.setText(((RecorderTime) getChild(groupPosition,
                    childPosition)).getName());
            childHolder.textAge.setText(String.valueOf(((RecorderTime) getChild(
                    groupPosition, childPosition)).getAge()));
            childHolder.textAddress.setText(((RecorderTime) getChild(groupPosition,
