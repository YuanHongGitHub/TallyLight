...
import com.qq281982108.sqlitedemo.R;

import java.util.ArrayList;
import java.util.List;

public class MainActivity000 extends Activity implements
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(MainActivity000.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(MainActivity000.this,
