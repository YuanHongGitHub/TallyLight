...
import com.qq281982108.tallylight.util.SizeConvertUtil;
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(getResources().getColor(R.color.colorLightGray));
        ...
        selectPaint.setColor(getResources().getColor(R.color.colorBlue));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.colorLightBlue));
    ...
    public void setBackground(Drawable background) {
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                centerLinePaint.setColor(getResources().getColor(R.color.colorWhite));
