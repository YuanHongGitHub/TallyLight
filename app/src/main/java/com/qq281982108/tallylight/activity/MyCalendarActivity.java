 ...
 * 项目名称：TallyLight
 * 创建人：yh
 * 创建时间：2016-03-29 15:11
 * 类名：MyCalendarActivity
 * 修改备注：
 */
    ...
    private void addGridView() {
        ...
        gridView.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                return MyCalendarActivity.this.gestureDetector.onTouchEvent(event);
            }
        });
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if (startPosition <= position + 7 && position <= endPosition - 7) {
                    ...
                    Toast.makeText(MyCalendarActivity.this, scheduleYear + "-" + scheduleMonth + "-" + scheduleDay, Toast.LENGTH_SHORT).show();
